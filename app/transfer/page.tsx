          ...
          <div className="container">
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4">
                ...
                <div className="mx-auto max-w-[500px] rounded-lg bg-opacity-5  dark:bg-swap py-6 px-6 mb-[-20px]"
                    ...
                    <div className="flex-col flex-1">
                      <div className="flex w-full">
                        <div className="relative shrink-0  pr-4" onClick={() => togglePopup(SWAP.Source)}>
                          {source == null ? <DefaultButton></DefaultButton> :
                              <ChooseButton coinInfo={source}></ChooseButton>}
                        </div>
                        <div className="w-full">
                          <div
                              className="flex justify-center mb-4 flex-col w-full text-right text-[18px] lg:text-[24px] font-bold items-end">
                            <input className="bg-transparent text-right text-white outline-none w-full lg:max-w-auto"
                                   value={sourceValue} onChange={(e) => handleInputChange(e, SWAP.Source)}
                                   disabled={!source}
                ...
                <div className="mx-auto max-w-[500px] text-center">
                  <button>
                    <div
                        className="cursor-pointer flex items-center justify-center w-[46px] h-[46px] bg-[#1D285A] rounded-full p-2"
                        style={{border: '2px solid rgb(12, 63, 109)'}} onClick={change}>
                      <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                           className="w-[20px] h-[20px]">
                        <path d="M4.16699 14.166L6.66699 16.666L9.16699 14.166" stroke="white" stroke-width="1.5"
                              stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M13.333 3.33398L13.333 16.6673M6.66634 16.6673L6.66634 3.33398L6.66634 16.6673Z"
                              stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M15.833 5.83398L13.333 3.33398L10.833 5.83398" stroke="white" stroke-width="1.5"
                              stroke-linecap="round" stroke-linejoin="round"></path>
                      </svg>
                    </div>
                  </button>
                </div>
                <div className="mx-auto max-w-[500px] rounded-lg bg-opacity-5 py-6 px-6 dark:bg-swap mt-[-20px]"
                     style={desCardstyle}>
                  <div className="w-full flex flex-row border-b-[1px] border-[#0C3F6D] pb-3 mb-6">
