...
const PopupItem = ({coinInfo, onItemSelected}) => {
    return (
        <div className="p-0">
                        <div className="justify-between mb-4 flex items-center rounded-[30px] text-def lg:text-[24px] font-medium cursor-pointer" onClick={()=>onItemSelected(coinInfo)}>
